...
import joblib
from autointplus import AutoIntMLP
from autointplus import predict_model
from autointplus import test_model
...
def load_data():
    ...
    '''
    project_path = '/Users/hayan/autointplus'
    data_dir_nm = 'data'
    ...
    model.load_weights(f'/Users/hayan/autointplus/model/autoIntMLP_model_weights_2.h5', by_name=True)
